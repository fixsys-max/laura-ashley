...
def generate_wrong_registration_data():
    ...
    case2 = {'mail': f'{round(time() * 1000)}@test.com',
            'phone': f'38{str(round(time() * 1000))[-10:]}',
            'password': '1234',
            'confirm': '1234',
            'first_name': 'TestUser',
    ...
    case3 = {'mail': f'{round(time() * 1000)}@test.com',
             'phone': f'38{str(round(time() * 1000))[-10:]}',
             'password': 'qwertyui',
             'confirm': 'qwertyui',
             'first_name': 'TestUser',
    ...
    case4 = {'mail': f'{round(time() * 1000)}@test.com',
             'phone': f'38{str(round(time() * 1000))[-10:]}',
             'password': 'qwerty12',
             'confirm': 'qwerty12',
             'first_name': 'TestUser',
    ...
    case5 = {'mail': f'{round(time() * 1000)}@test.com',
             'phone': f'38{str(round(time() * 1000))[-10:]}',
             'password': 'qwerty1@',
             'confirm': 'qwerty1@',
             'first_name': 'TestUser',
    ...
    case6 = {'mail': f'{round(time() * 1000)}@test.com',
             'phone': f'38{str(round(time() * 1000))[-10:]}',
             'password': 'Qwerty1@',
             'confirm': '12345678',
             'first_name': 'TestUser',
    ...
    case11 = {'mail': f'{round(time() * 1000)}@test.com',
    ...
    case12 = {'mail': f'{round(time() * 1000)}@test.com',
              'phone': f'12345',
              'password': 'Qwerty1@',
              'confirm': 'Qwerty1@',
              'first_name': 'TestUser',
    ...
    case13 = {'mail': f'{round(time() * 1000)}@test.com',
             'phone': f'38{str(round(time() * 1000))[-10:]}',
             'password': 'Qwerty1@',
             'confirm': 'Qwerty1@',
             'first_name': '1',
    ...
    case14 = {'mail': f'{round(time() * 1000)}@test.com',
              'phone': f'38{str(round(time() * 1000))[-10:]}',
              'password': 'Qwerty1@',
              'confirm': 'Qwerty1@',
              'first_name': 'TestUser',
